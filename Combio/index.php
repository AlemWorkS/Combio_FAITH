            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables tubes">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables tubes">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Gel Aloe Vera Bio </a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables huiles">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Huile de Nigelle</a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood huiles">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Huile de Fenugrec</a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat huiles">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Huile Argan</a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges huiles">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Huile olive</a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat huiles">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Huile Ail pour cheveux sans odeur</a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood huiles">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Huile de Ricin</a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat sachets">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/featured/feature-9.png">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Anis Vert</a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat sachets">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/featured/feature-10.png">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="./shop-details.html">Poudre de Fenugrec</a></h6>
                            <h5>$30.00</h5>
                        </div>
                    </div>
                </div>
