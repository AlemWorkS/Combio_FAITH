  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
      ...
      <a class="navbar-brand brand-logo" href="../samples/orders.php"><img src="../../img/logo.png" alt="logo" style ="height:100px ;display: flex;"/></a>
        <a class="navbar-brand brand-logo-mini" href="../samples/orders.php"><img src="../../img/logo.png"  style ="object-fit:cover ; height:60px;"alt="logo"></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="position:sticky;left:0px;">
        <ul class="nav">
          ...
          <!--Accès aux clients-->
          <li class="nav-item">
            <a class="nav-link" href="../tables/clients.html">
              <i class="fas fa-user-friends menu-icon"></i>
              <span class="menu-title">Clients</span>
              <i class="menu-arrow"></i>
            </a>
          </li>
          <!--Fin accès aux clients-->
                        ...
                        <table id="order-listing" class="table" border="1" >
                          <thead>
                            <tr class="bg-primary text-white"  >
                                <th style="background: #f2f2f2; color:black;">no_commande</th>
                                <th style="background: #f2f2f2; color:black;">date_commande</th>
                                <th style="background: #f2f2f2; color:black;">adresse_livraison</th>
                                <th style="background: #f2f2f2; color:black;">no_client</th>
                                <th style="background: #f2f2f2; color:black;">id_paiement</th>
                                <th style="background: #f2f2f2; color:black;">id_vpaiement</th>
                                <th style="background: #f2f2f2; color:black;">lib_vpaiement</th>
                        ...
                        <td>
                          ...
                          <td>
                              <form class="userDatatable-content" method="POST" action="supprimer_commande.php">
                                  <input type="hidden" value="<?=$row["no_commande"]?>" name="supprimer">
